...
pub1 = rospy.Publisher('/des_Pos', Pose, queue_size=10) #Identify the publisher "pub1" to publish on topic "/APF_Des_Pos" to send message of type "Pose"
...
Obs_Pos = [-0.75, 0.0]
APF_Param = [10, 130, 0.65] #[K_att,K_rep,q_star]
#######################################################################
#######################################################################
#APF Equations
x_rob = symbols('x_rob')
